...
Внося вклад в код, сообщая об ошибках, помогая с документацией или поддерживая проект финансово (см. [Поддержка](../README.md#-support-the-project)). Каждый вклад помогает двигаться вперёд быстрее.

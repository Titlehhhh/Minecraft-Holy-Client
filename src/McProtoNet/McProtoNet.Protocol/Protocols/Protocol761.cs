...
namespace McProtoNet.Protocol761
{
    public sealed class Protocol_761 : ProtocolBase
    {
        public Protocol_761(IPacketBroker client) : base(client)
        {
            SupportedVersion = 761;
        }
        ...
        protected override void OnPacketReceived(InputPacket packet)
        {
            switch (packet.Id)
            {
                ...
                case 0x64:
                    ...
                    break;
                case 0x67:
                    if (_onfeature_flags.HasObservers)
                    {
                        scoped var reader = new MinecraftPrimitiveReaderSlim(packet.Data);
                        var tempArrayLength_0_0 = reader.ReadVarInt();
                        var tempArray_0_0 = new string[tempArrayLength_0_0];
                        for (int i_0_0 = 0; i_0_0 < tempArrayLength_0_0; i_0_0++)
                        {
                            var for_item_0_0 = reader.ReadString();
                            tempArray_0_0[i_0_0] = for_item_0_0;
                        }

                        string[] features = tempArray_0_0;
                ...
                case 0x41:
                    if (_onserver_data.HasObservers)
                    {
                        ...
                        _onserver_data.OnNext(new PacketServerData(motd, icon, enforcesSecureChat));
                    }
    ...
    {
        public PacketServerData(string? motd, string? icon, bool enforcesSecureChat)
        {
            Motd = motd;
            Icon = icon;

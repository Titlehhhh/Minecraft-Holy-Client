...
namespace McProtoNet.Protocol762
{
    public sealed class Protocol_762 : ProtocolBase
    {
        public Protocol_762(IPacketBroker client) : base(client)
        {
            SupportedVersion = 762;
        }

            ...
            switch (packet.Id)
            {
                ...
                case 0x18:
                    if (_onhide_message.HasObservers)
                    {
                        ...
                        byte[] signature = reader.ReadBuffer(tempArrayLength_0_0);
                ...
                case 0x62:
                    if (_onsystem_chat.HasObservers)
                    {
                        ...
                        bool isActionBar = reader.ReadBoolean();
                ...
                case 0x42:
                    if (_onserver_data.HasObservers)
                    {
                        ...
                        bool enforcesSecureChat = reader.ReadBoolean();
                ...
                case 0x32:
                    if (_onmessage_header.HasObservers)
                    {
                        ...
                        byte[] signature = reader.ReadBuffer(tempArrayLength_2_0);
                        var tempArrayLength_3_0 = reader.ReadVarInt();
                        byte[] messageHash = reader.ReadBuffer(tempArrayLength_3_0);

            ...
            case 0x26:
                if (_onlogin.HasObservers)
                {
                    ...
                    _onlogin.OnNext(new PacketLogin(entityId, isHardcore, gameMode, previousGameMode, worldNames,
                        dimensionCodec, dimension, worldName, hashedSeed, maxPlayers, viewDistance, simulationDistance,
...
public class PacketLogin
{
    public PacketLogin(int entityId, bool isHardcore, byte gameMode, sbyte previousGameMode, string[] worldNames,
        ...
        int simulationDistance, bool reducedDebugInfo, bool enableRespawnScreen, bool isDebug, bool isFlat)
    {
        EntityId = entityId;

...
namespace McProtoNet.Protocol759
{
    public sealed class Protocol_759 : ProtocolBase
    {
        ...
        public ValueTask SendChatMessage(string message, long timestamp, long salt, byte[] signature,
            bool signedPreview)
        {
            scoped var writer = new MinecraftPrimitiveWriterSlim();
            ...
            switch (packet.Id)
            {
                case 0x00:
                    if (_onspawn_entity.HasObservers)
                    {
                        ...
                        int objectData = reader.ReadVarInt();
                ...
                case 0x07:
                    if (_ontile_entity_data.HasObservers)
                    {
                        ...
                        NbtTag? nbtData = reader.ReadOptionalNbt();
                ...
                case 0x0c:
                    ...
                    {
                        scoped var reader = new MinecraftPrimitiveReaderSlim(packet.Data);
                        int queryId = reader.ReadSignedInt();
                        string? message = null;
                ...
                case 0x61:
                    ...
                    {
                        scoped var reader = new MinecraftPrimitiveReaderSlim(packet.Data);
                        int transactionId = reader.ReadVarInt();
                        NbtTag? nbt = reader.ReadOptionalNbt();
                ...
                case 0x16:
                    if (_onnamed_sound_effect.HasObservers)
                    {
                        ...
                        long seed = reader.ReadSignedLong();
                ...
                case 0x30:
                    ...
                    {
                        scoped var reader = new MinecraftPrimitiveReaderSlim(packet.Data);
                        string signedChatContent = reader.ReadString();
                        string? unsignedChatContent = null;
                        if (reader.ReadBoolean())
                        {
                            unsignedChatContent = reader.ReadString();
                        }

                        int type = reader.ReadVarInt();
                        Guid senderUuid = reader.ReadUUID();
                        ...
                        byte[] signature = reader.ReadBuffer(tempArrayLength_8_0);
                        _onplayer_chat.OnNext(new PacketPlayerChat(signedChatContent, unsignedChatContent, type,
                            senderUuid, senderName, senderTeam, timestamp, salt, signature));
                    }
                ...
                case 0x4b:
                    ...
                    {
                        scoped var reader = new MinecraftPrimitiveReaderSlim(packet.Data);
                        bool shouldDisplayChatPreview = reader.ReadBoolean();
                        _onshould_display_chat_preview.OnNext(
                            new PacketShouldDisplayChatPreview(shouldDisplayChatPreview));
                    }
                ...
                case 0x3f:
                    if (_onserver_data.HasObservers)
                    {
                        ...
                        bool previewsChat = reader.ReadBoolean();
                ...
                case 0x05:
                    ...
                    {
                        scoped var reader = new MinecraftPrimitiveReaderSlim(packet.Data);
                        int sequenceId = reader.ReadVarInt();

        ...
        public override void OnPacketReceived(InputPacket packet)
        {
            switch (packet.Id)
            {
                ...
                case 0x30:
                {
                    ...
                    if (!reader.ReadBoolean())
                    {
                        var unsignedChatContent = null;
                    }
                    else
                    {
                        var unsignedChatContent = reader.ReadString();
                    }

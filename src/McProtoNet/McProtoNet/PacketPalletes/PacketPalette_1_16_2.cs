...
namespace McProtoNet
{
	public class PacketPalette_1_16_2 : IPacketPallete
	{
		...
		private readonly FrozenDictionary<int, PacketIn> typeIn = FrozenDictionary.ToFrozenDictionary(new Dictionary<int, PacketIn>()
		{
			...
			{ 0x0F, PacketIn.TabComplete },
			{ 0x10, PacketIn.DeclareCommands },
			{ 0x11, PacketIn.WindowConfirmation },
			{ 0x12, PacketIn.CloseWindow },
			{ 0x13, PacketIn.WindowItems },
			{ 0x14, PacketIn.WindowProperty },
			{ 0x15, PacketIn.SetSlot },
			{ 0x16, PacketIn.SetCooldown },
			{ 0x17, PacketIn.PluginMessage },
			{ 0x18, PacketIn.NamedSoundEffect },
			{ 0x19, PacketIn.Disconnect },
			{ 0x1A, PacketIn.EntityStatus },
			{ 0x1B, PacketIn.Explosion },
			{ 0x1C, PacketIn.UnloadChunk },
			{ 0x1D, PacketIn.ChangeGameState },
			{ 0x1E, PacketIn.OpenHorseWindow },
			{ 0x1F, PacketIn.KeepAlive },
			{ 0x20, PacketIn.ChunkData },
			{ 0x21, PacketIn.Effect },
			{ 0x22, PacketIn.Particle },
			{ 0x23, PacketIn.UpdateLight },
			{ 0x24, PacketIn.JoinGame },
			{ 0x25, PacketIn.MapData },
			{ 0x26, PacketIn.TradeList },
			{ 0x27, PacketIn.EntityPosition },
			{ 0x28, PacketIn.EntityPositionRotation },
			{ 0x29, PacketIn.EntityRotation },
			{ 0x2A, PacketIn.EntityMovement },
			{ 0x2B, PacketIn.VehicleMove },
			{ 0x2C, PacketIn.OpenBook },
			{ 0x2D, PacketIn.OpenWindow },
			{ 0x2E, PacketIn.OpenSignEditor },
			{ 0x2F, PacketIn.CraftRecipeResponse },
			{ 0x30, PacketIn.PlayerAbilities },
			{ 0x31, PacketIn.CombatEvent },
			{ 0x32, PacketIn.PlayerInfo },
			{ 0x33, PacketIn.FacePlayer },
			{ 0x34, PacketIn.PlayerPositionRotation },
			{ 0x35, PacketIn.UnlockRecipes },
			{ 0x36, PacketIn.DestroyEntities },
			{ 0x37, PacketIn.RemoveEntityEffect },
			{ 0x38, PacketIn.ResourcePackSend },
			{ 0x39, PacketIn.Respawn },
			{ 0x3A, PacketIn.EntityHeadLook },
			{ 0x3B, PacketIn.MultiBlockChange },

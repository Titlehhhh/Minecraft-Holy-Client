...
public static class Utf8ValueStringBuilderExtensions
{
    ...
    {
        var destination = builder.GetSpan(0);
    ...
    private static void WriteMultiSegment(this ref Utf8ValueStringBuilder builder, in ReadOnlySpan<byte> source,
        Span<byte> destination)
    {
        ...
        while (true)
        {
            ...
            if (input.Length > 0)
            {
                ...
                if (destination.IsEmpty) throw new ArgumentOutOfRangeException();

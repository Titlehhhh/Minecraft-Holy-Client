using McProtoNet.Protocol756.Packets.Client;
using McProtoNet.Protocol756.Packets.Server;
using System;
...
{
    public sealed class PacketFactory756 : PacketFactory
    {
        protected override (Dictionary<int, Type>, Dictionary<int, Type>) CreatePackets(PacketCategory category)
        {
            ...
            else if (category == PacketCategory.Game)
            {
                outPackets = new()
                {
                    ...
                    { 0x0A, typeof(ClientPluginMessagePacket) },
                    ...
                    { 0x0F, typeof(ClientKeepAlivePacket) },
                   // { 0x11, typeof(ClientLockDifficultyPacket) },
                    ...
                    { 0x1A, typeof(ClientPlayerActionPacket) },
                ...
                inPackets = new()
                {
                    ...
                    { 0x0F, typeof(ServerChatPacket) },
                    { 39, typeof(ServerMapDataPacket) },
                    ...
                    { 0x21, typeof(ServerKeepAlivePacket) },
                    ...
                    { 0x26, typeof(ServerJoinGamePacket) },

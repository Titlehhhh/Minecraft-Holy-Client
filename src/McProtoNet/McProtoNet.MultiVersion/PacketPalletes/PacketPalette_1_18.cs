namespace McProtoNet.MultiVersion
{
    public class PacketPalette_1_18 : IPacketPallete
    {
        private readonly Dictionary<int, PacketIn> typeIn = new()
        {
            ...
            { 0x57, PacketIn.UpdateSimulationDistance },
            { 0x58, PacketIn.SetTitleSubTitle },
            { 0x59, PacketIn.TimeUpdate },
            { 0x5A, PacketIn.SetTitleText },
            { 0x5B, PacketIn.SetTitleTime },
            { 0x5C, PacketIn.EntitySoundEffect },
            { 0x5D, PacketIn.SoundEffect },
            { 0x5E, PacketIn.StopSound },
            { 0x5F, PacketIn.PlayerListHeaderAndFooter },
            { 0x60, PacketIn.NBTQueryResponse },
            { 0x61, PacketIn.CollectItem },
            { 0x62, PacketIn.EntityTeleport },
            { 0x63, PacketIn.Advancements },
            { 0x64, PacketIn.EntityProperties },

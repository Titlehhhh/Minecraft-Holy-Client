...
public class Tr : MarkupExtension
{
    ...
    public object ProvideValue(IServiceProvider serviceProvider, bool InMultiTr)
    {
        ...
        try
        {
            if (string.IsNullOrEmpty(TextId) && TextIdBinding == null && dependencyObject != null &&
        ...
        if (IsDynamic)
        {
            ...
            if (StringFormatArgBinding == null && StringFormatArgsBindings.Count == 0 && TextIdBinding == null)
            {
                ...
                if (InMultiTr || dependencyObject == null || dependencyProperty == null) return binding;
    ...
    protected class ForTrMarkupInternalStringFormatMultiValuesConverter : IMultiValueConverter
    {
        ...
        public object Convert(IList<object> values, Type targetType, object parameter, CultureInfo culture)
        {
            try
            {
                ...
                if (TextIdBinding is MultiBinding textIdMultiBinding)
                {
                    Data.TextId = textIdMultiBinding.Converter
                        .Convert(values.Take(textIdMultiBinding.Bindings.Count).ToArray(), null,
                            textIdMultiBinding.ConverterParameter, TrConverterCulture).ToString();
                ...
                {
                    Data.Model = modelBinding.Converter
                        .Convert(values.Skip(offset).Take(modelBinding.Bindings.Count).ToArray(), null,
                            modelBinding.ConverterParameter, TrConverterCulture).ToString();
                ...
                if (DefaultTextBinding is MultiBinding defaultTextMultiBinding)
                {
                    Data.DefaultText = defaultTextMultiBinding.Converter
                        .Convert(values.Skip(offset).Take(defaultTextMultiBinding.Bindings.Count).ToArray(), null,
                            defaultTextMultiBinding.ConverterParameter, TrConverterCulture).ToString();
                ...
                for (var i = 0; i < StringFormatBindings.Count; i++)
                    if (StringFormatBindings[i] is MultiBinding stringFormatMultiBinding)
                    {
                        var bindingsCount = stringFormatMultiBinding.Bindings.Count;
                        stringFormatArgs.Add(stringFormatMultiBinding.Converter.Convert(
                            values.Skip(offset).Take(bindingsCount).ToArray(), null,
                            stringFormatMultiBinding.ConverterParameter, TrConverterCulture));
                ...
                return TrConverter == null
                    ? translated
                    : TrConverter.Convert(translated, null, TrConverterParameter, TrConverterCulture);
            }
            catch
            {
                return string.Empty;
    ...
    public Tr(object textId, IBinding arg1, IBinding arg2, IBinding arg3, IBinding arg4, IBinding arg5,
        IBinding arg6) : this(textId)
    {
        ManageArg(new List<IBinding> { arg1, arg2, arg3, arg4, arg5, arg6 });
    }

    public Tr(object textId, IBinding arg1, IBinding arg2, IBinding arg3, IBinding arg4, IBinding arg5, IBinding arg6,
        IBinding arg7) : this(textId)
    {
        ManageArg(new List<IBinding> { arg1, arg2, arg3, arg4, arg5, arg6, arg7 });
    }

    public Tr(object textId, IBinding arg1, IBinding arg2, IBinding arg3, IBinding arg4, IBinding arg5, IBinding arg6,
        IBinding arg7, IBinding arg8) : this(textId)
    {

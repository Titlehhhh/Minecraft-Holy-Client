...
public class LocalizationLoader
{
    ...
    public static LocalizationLoader Instance => instance ?? (instance = new LocalizationLoader(Loc.Instance));

    public List<ILocalizationFileLoader> FileLanguageLoaders { get; set; } = new();
    ...
    {
        foreach (var item in FileLanguageLoaders) item.LoadFile(file, this);
    }

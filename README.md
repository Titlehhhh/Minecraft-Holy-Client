...
Бесплатное удобное приложение, чтобы эмулировать высокую нагрузку на сервер майнкрафт. Также это приложение служит наглядным примером использования библиотеки McProtoNet, где она показывает невероятную производительность.

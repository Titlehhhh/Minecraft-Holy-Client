...
Программа потребляет примерно 100 мб оперативной памяти во время ДДОСА или спам атаки. Это действительно лучше, чем у Java аналогов, но у программы есть проблемы с многопоточностью. Создается очень много потоков, которые 99% процентов времени ожидают ответа от сети. Начиная с версии 1.0.0.20 будет идти работа в направлении оптимизации, поэтому обновления будут реже.
